...
if __name__ == "__main__":
    ...
    file_path = r"...\11star_sudoku.txt"

    # Now you can proceed with solving Sudoku using the provided file_path
    Sudoku = readCSPFromFile(file_path)
    print("Initial Puzzle: {}".format(file_path))
    print(Sudoku)
    AC3(Sudoku)
